...
class QualityGates:
    ...
    block_on_cohort_mismatch: bool = True
...
def load_pipeline_config(path: Path) -> PipelineConfig:
    ...
    gates = QualityGates(
        ...
        block_on_cohort_mismatch=bool(gates_raw.get("block_on_cohort_mismatch", True)),
    )
    llm = LLMConfig(
        ...
        default_model=_env_str("LLM_DEFAULT_MODEL", str(llm_raw.get("default_model", "deepseek-ai/DeepSeek-V3"))),
