...
from .paper_contract import assign_paper_tyg_quartile, build_paper_alignment_contract
...
def run_cohort_stats_analysis(
    ...
    km_hospital_plot_path = results_dir / "km_hospital_tyg.png"
    km_icu_plot_path = results_dir / "km_icu_tyg.png"
    ...
    km_hospital = _fit_km_by_quartile(
        ...
        output_path=km_hospital_plot_path,
        endpoint="hospital",
    )
