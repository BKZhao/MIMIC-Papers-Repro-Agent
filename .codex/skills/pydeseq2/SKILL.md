---
name: pydeseq2
description: Differential gene expression analysis (Python DESeq2). Identify DE genes from bulk RNA-seq counts, Wald tests, FDR correction, volcano/MA plots, for RNA-seq analysis. Also use for 差异表达, bulk RNA-seq, count matrix analysis, DESeq2-style workflows, 火山图, MA plot, and gene-level differential expression in paper reproduction.
license: MIT license
metadata:
