...
description: Work with Data Commons, a platform providing programmatic access to public statistical data from global sources. Use this skill when working with demographic data, economic indicators, health statistics, environmental data, or any public datasets available through Data Commons. Applicable for querying population statistics, GDP figures, unemployment rates, disease prevalence, geographic entity resolution, and exploring relationships between statistical entities. Also use for 公共统计数据, 区域控制变量, demographic covariates, policy background indicators, cross-source public data enrichment, and supplementing econometric policy analysis with public reference data.
license: Unknown
metadata:
